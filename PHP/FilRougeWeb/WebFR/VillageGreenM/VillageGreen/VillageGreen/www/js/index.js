...
$(document).ready(function () {
	...
	$("#button1").click(function (event, ui) {
	    ...
	    var apiURL = "http://dl.bienvu.net/dude/VillageGreenM/js/encodageall.php";
	    console.log(apiURL);
	...
	$(document).on('pagebeforeshow', '#page3', function(){
		...
		$.each(listeDesArticles, function(i, ligne) {
			if(ligne.RefArticle == RefArticle) {
				console.log(ligne);
				$('#detailsArticle').append('<li><img src="http://dl.bienvu.net/dude/VillageGreen/'+ligne.PhotoArticle+'"></li>');
	...
	function AfficheResult(data){
		...
		{ 
			...
			codeHTML += '<img src="http://dl.bienvu.net/dude/VillageGreen/'+ligne.PhotoArticle+'"/>';
