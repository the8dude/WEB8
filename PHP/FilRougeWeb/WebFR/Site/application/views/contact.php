		...
		<div class="mdl-grid sanspadding">
	  		...
	  		<div class="mdl-cell mdl-cell--8-col sansmargin">
	  			...
	  			<div class="bodycontact">
	  				...
	  				<div class="sans margin contacth2">
	  					<h2>Contact</h2>
	  				</div>	
	  				<br>
					<div id="bodycontactdiv1">
						Une question, une suggestion ?
						<br><br>
						N’hêsitez pas à contacter nos équipes, sur Twitter ou en utilisant le formulaire ci-dessous :
						<br><br>
					</div>
					
					<div>
						<form method="post" id="form1">
							<input type="texte" name="nom" placeholder="Nom*" class="inputcontact" id="nom" />
							<div id="errornom" class="error">Veuillez saisir un "nom".</div>
							<br><br>

							<input type="texte" name="prenom" placeholder="Prénom" class="inputcontact" id="prenom"/>
							<br><br>

							<input type="texte" name="email" placeholder="Email*" class="inputcontact" id="email"/>
							<div id="erroremail" class="error">Veuillez saisir un "email".<br>ex : nom@exemple.com</div>
							<br><br>

							<input type="texte" name="objet" placeholder="Objet*" class="inputcontact" id="objet"/>
							<div id="errorobjet" class="error">Veuillez saisir un "objet".</div>
							<br><br>

							<textarea type="texte" name="message" placeholder="Message*" class="textareacontact" id="message"></textarea>
							<div id="errormessage" class="error">Veuillez saisir un "message".<br>Minimum 10 caractères.</div>
							<br>

							<div class="label">*Champs obligatoires</div><br>
							<input type="submit" name="envoyer" value="Envoyer" class="buttoncontact" id="submit" />
			  				<input type="reset" name="effacer" value="Effacer" class="buttoncontact" id="reset" />
						</form>
						<br><br>
						<br><br>
					</div>
...
<!-- JS Gestion formulaire -->
<script src="<?=base_url("jscript/contact.js")?>"></script>